...
namespace Ễ
{
    public partial class C1_Bai3 : Form
    {
        ...
        {
            if (txtNumber1.Text.Trim().Length > 0 && char.IsDigit(txtNumber1.Text, txtNumber1.Text.Length - 1) && (txtNumber2.Text.Trim().Length > 0 && char.IsDigit(txtNumber2.Text, txtNumber2.Text.Length - 1)))
                {
